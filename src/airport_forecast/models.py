...
def recursive_forecast_global(
    ...
    if honest_exog:
        work = assume_future_exog(
            work, origin, airports, origin_by_airport=origin_by_airport,
        )
...
def forecast_future_global(
    ...
    recurse. Unlike a backcast, every returned date is strictly after each airport's
    last available actual. Returns columns: airport, date, pax_pred."""
